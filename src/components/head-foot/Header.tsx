...
export class Header extends React.Component<IState, any> {
    ...
    render() {
        return <div>
            <header className="head bg-justeat">

                <div className="barnav head">
                    <div className="head-start ms-2">
                        <div className="head-back me-2">
                            <Link to="/" className="text-white"><FontAwesomeIcon icon={faAngleLeft} /></Link>
                        </div>
                        <div className="d-none d-sm-block">
                            <img className="logo-just" height="33px" src="./img/logo-justeat.svg" alt="Logo Just Eat" />
                        </div>
                    ...
                    <div className="head-end">
                        ...
                        <div className="ms-3 fs-20 pointer" onClick={() => { this.handleModal() }}>
            ...
            <Modal show={this.state.show}>
                <Modal.Body>
                    <div id="userpanel-wrapper" className="userpanel__wrapper_next">
                        <section className="top-content flex">                            
                        ...
                        <section className="bottom-content bg-white mt-4 shadow p-3">
                            <section className="text-center">
                                <a href="#" className="btn btn-primary btn-sm me-3">
                                    Se connecter                        </a>
                                <a href="#" className="btn border btn-sm">
                                    Créer un compte                        </a>
                            </section>
                            <ul className="mt-5 ml--33">
                                <li className="mb-3">
                                    <Link to="/point" className="btn border w-100">Points</Link>
                                </li>
                                <li className="mb-3">
                                    <Link to="/livraison" className="btn border w-100">Livraison</Link>
                                </li>
                                <li className="mb-3">
                                    <Link to="/service-clientele" className="btn border w-100">Besoin d'aide ?</Link>
                                </li>
                                <li>
                                    <Link to="/takeaway" className="btn border w-100">Takeaway Pay (B2B)</Link>
                                </li>
                            </ul>
                        </section>
                    </div>
